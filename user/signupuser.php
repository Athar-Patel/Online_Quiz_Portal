...
if (!$rs) {
  die("An Error Has Occurred! Error: " . mysql_error());
}

echo "<br><br><br><div class=head1>Your Login ID  $lid Is Created Successfully</div>";
echo "<br><div class=head1>Please Login using your Login ID & Credentials to take Quiz</div>";
