...
if (isset($_POST["submit"]) && $_POST["submit"] == 'Save' || isset($_POST["subid"]) && strlen($_POST["subid"]) > 0)
{
extract($_POST);
...
<form name="form1" method="post" onSubmit="return check();">
  <table width="58%"  border="0" align="center">
    <tr>
      <td width="49%" height="32"><div align="left"><strong>Enter Subject :</strong></div></td>
      <td width="3%" height="5">  
...
?>
    ...
    <tr>
        ...
        <td>&nbsp;</td>
	  <td><input name="testname" type="text" id="testname" placeholder = "Enter Chapter Name"></td>
    </tr>
    <tr>
      <td height="26"><div align="left"><strong>Enter Total Questions :</strong></div></td>
      <td>&nbsp;</td>
      <td><input name="totque" type="text" id="totque" placeholder="Enter Total Questions"></td>
    </tr>
    <tr>
      <td height="26"></td>
      <td>&nbsp;</td>
